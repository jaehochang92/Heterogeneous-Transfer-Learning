...
target_26_var = colnames(GSE26_eset)[which(colnames(GSE26_eset) %in% rownames(target_sel)[target_sel[, 1] !=
                                                                                            0])]
write.csv(target_26_var, file = 'target_var.csv')
...
write.csv(proxy_98_var, file = 'proxy_var.csv')